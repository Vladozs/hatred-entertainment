...
<head>
  ...
  <title>Перенос выхода WRECK Eternal</title>
  <meta name="description" content="Перенос планируется на март-апрель 2026 года.">
...
<body>
  ...
  <div class="container">
    <div class="main">
      ...
      <h1>Выход WRECK Eternal переносится на март-апрель 2026 года</h1>
      <div class="meta">09.01.2026 21:56 • <strong>Анонс</strong></div><div class="news-photo" style="text-align:center;">
        <img src="/news/uploads/513b35de8843efd3.png" alt="" style="max-width:100%; height:auto; border-radius:16px;">
      </div>
      <div class="content"><div class="text-block">
Первый акт игры планируется к выходу в марте-апреле 2026 года на площадках Steam, VK Play и itch io.<br>
Из причин выделяют готовность первого акта всего на 50% и проблемы с платформой Steam.<br><br>

WRECK Eternal - это экшен-шутер от первого лица с глубоким и тяжелым сюжетом про насилие, как часть человека.<br><br>


Скриншот из игры:
<div class="news-photo" style="text-align:center;">
                    <img  src="/news/uploads/09905b013012b167.jpg" style="max-width:100%; height:auto; border-radius:16px;">
                </div></div></div>
  ...
  fetch("/news/news.json?nocache="+Date.now()).then(r=>r.json()).then(j=>{
    ...
    const related = j.articles.filter(a=>a.slug!=="wreck-eternal-release-delay")
