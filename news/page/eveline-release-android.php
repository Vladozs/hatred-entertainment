...
<head>
  ...
  <title>Эвелина готовится к выходу на андроид!</title>
  <meta name="description" content="Трепещите!">
...
<body>
  ...
  <div class="container">
    <div class="main">
      ...
      <h1>Эвелина готовится к выходу на андроид!</h1>
      <div class="meta">13.09.2025 22:09 • <strong>Анонс</strong></div><div class="news-photo" style="text-align:center;">
        <img src="/news/uploads/c6df2630c219a984.png" alt="" style="max-width:60%; height:auto; border-radius:16px;">
      </div>
      <div class="content"><div class="text-block">
В скором времени "Эвелина" или "Eveline" от студии HATRED Entertainment выйдет на андроид, на площадках Google Play, а также на RuStore, так что готовьтесь, скоро будет жарко! (а может и холодно)

<div class="news-photo" style="text-align:center;">
                    <img  src="/news/uploads/3266824e8a055e7c.jpg"" style="max-width:40%; height:auto; border-radius:16px;">
                </div></div></div>
  ...
  fetch("/news/news.json?nocache="+Date.now()).then(r=>r.json()).then(j=>{
    ...
    const related = j.articles.filter(a=>a.slug!=="eveline-release-android")
      .sort((a,b)=> new Date(b.date)-new Date(a.date))
      .slice(0,3);
    const box=document.getElementById("related");
    related.forEach(article=>{
      const a=document.createElement("a");
      a.href="/news/page/"+article.slug+".php";
